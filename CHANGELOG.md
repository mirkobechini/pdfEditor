...
- ✅ **Bug B20: admin.py return type errato** — Corretta annotation a UserListResponse (PR #326, issue #325)- ✅ **ADR audit** — Aggiunta sezione con 21 bug trovati nel codice + 10 miglioramenti
