...
describe("tauri utilities (unit)", () => {
  ...
  it("getApiBaseUrl returns 127.0.0.1:7723 when __TAURI_INTERNALS__ is set", async () => {
    // Simulate Tauri environment
    (window as any).__TAURI_INTERNALS__ = { invoke: async () => 7723 };
  ...
  it("tauriInvoke calls window.__TAURI_INTERNALS__.invoke with correct args", async () => {
