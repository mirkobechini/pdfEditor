...
| **Desktop: startup screen con 3 step di init**                  | Redirect diretto al login   | Nuova pagina `/startup` che mostra 3 step (sidecar health check, database connection, API verification) con transizioni spinner→checkmark e redirect automatico a wizard/login. Migliora UX su primo avvio.                                                                                                                                                                                            |
