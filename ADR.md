...
| **Desktop: system tray su close (pianificato)**                 | Uscita completa             | Alla chiusura finestra, l'app rimane in tray (icona nella barra strumenti). Click destro menu "Mostra PdfEditor" / "Esci". Sidecar NON killato finché non si clicca "Esci". Vedi `.specs/plans/feature-system-tray.md`.                                                                                                                                                                                |
