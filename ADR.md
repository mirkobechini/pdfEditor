...
| Playwright per test E2E cross-origin           | Solo test unitari                         | Suite E2E in `e2e/` (12 test) che copre i flussi cross-origin reali (cookie, CSRF, CORS) che i test unitari non possono verificare. Job `e2e` in `ci-web.yml`. (issue #731) |
