/**
 * Manual port of shared/src/print.ts — mobile's src/shared/ is not synced
 * via the copy-shared.js prebuild script used by desktop/web (it has its own
 * divergent shared layer), so this stays a hand-kept copy. Keep in sync with
 * shared/src/print.ts if the range-parsing logic ever changes.
 */
