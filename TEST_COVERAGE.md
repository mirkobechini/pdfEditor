...
| ------------------------------ | ----------- | ------- | ---------- | ----- |
| **Backend** (FastAPI/Python)   | pytest      | **407** | **89%**    | ✅    |
| **Webapp** (Next.js/React)     | vitest      | **610** | **91.84%** | ✅    |
| **Desktop** (Tauri)            | vitest      | **938** | **90.84%** | ✅    |
| **Mobile** (React Native/Expo) | jest        | **317** | **98.7%**  | ✅    |
| **E2E** (Playwright)           | playwright  | **15**  | —          | ✅    |

> ℹ️ **Backend**: 407 test (pytest), 89% statements. +8 test sign (issue #814).
>
